...
namespace cinder {
	namespace box2d {
		typedef boost::shared_ptr<class BoundaryElement> BoundaryElementRef;

		class BoundaryElement : public PhysicsElement 
		{
		public:
			BoundaryElement( b2World * world );
			BoundaryElement( b2World * world, Rectf screenBounds, float thickness=1.0f );
